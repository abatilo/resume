  ...
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        ...
        \resumeItemNoBold {Developed company wide self service GitOps AWS EKS PaaS using Terraform and GitHub Actions}
        \resumeItemNoBold {Implemented custom metrics and automatic horizontal scaling policies to respond to changes in load in real time}
        \resumeItemNoBold {Implemented distributed tracing across several microservices, reducing incident resolution time}
        \resumeItemNoBold {Integrated CI / CD pipeline to reduce manual deploy time from hours to fully automated single digit minutes}
        \resumeItemNoBold {Lowered AWS cost by 6 digits anually by improving EC2 utilization, and removing unused resources}
        ...
        \resumeItemNoBold {Taught team about using containers for hot reloaded, portable, repeatable, local development}
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItemNoBold{Wrote Python scripts for system monitoring across 40+ virtualized hosts on mission critical and secured network}
...
\section{Projects}
  ...
  \resumeSubItem{\href{https://www.aaronbatilo.dev}{Blog + Infra}}
    {My personal SRE / DevOps playground. My blog and other projects are served by my
      personal Kubernetes cluster. Self hosted: Jenkins,
      Spinnaker, Docker Registry; Managed: GitHub Actions, CodeFresh}
  \resumeSubItem{\href{https://www.actionspanel.app}{Actions Panel}}
    {Trigger your GitHub Actions manually.
