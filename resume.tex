...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      ...
      \resumeItemListStart
        \resumeItemNoBold {Lowered AWS cost by 5 digits anually by improving EC2 utilization, and removing unused resources}
        ...
        \resumeItemNoBold {Integrated CI / CD pipeline to reduce deploy time from hours to single digit minutes}
