...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Color Health (Remote)}
      {Staff Software Engineer - Tools and Infrastructure. Company wide technical leader}{January 2021 - Present}
      \resumeItemListStart
        ...
        \resumeItemNoBold {Driving scalability improvements increase capable QPS throughput from 10+ QPS to 1000+ QPS}
        \resumeItemNoBold {Integrating tracing and profiling systems to enable latency reduction from multiple seconds to under 500ms}
    ...
    \resumeSubheading
      ...
      {Technical Lead / Senior Software Engineer - Tools and Infrastructure}{August 2019 - January 2021}
      \resumeItemListStart
...
\section{Projects}
  ...
  \resumeSubItem{\href{https://www.aaronbatilo.dev}{https://www.aaronbatilo.dev}}
    {My website has a detailed list of non-work commissioned projects. Some of these projects have:}
      \resumeItemListStart
        \resumeItemNoBold{Been mentioned on the largest Colorado News TV Station, 9News}
        \resumeItemNoBold{Used by Microsoft, Docker, GitHub, MGM Resorts, etc. With implemented feature requests}
